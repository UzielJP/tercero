...
public class Excursion {
	...
	public ExcursionState getState() {return this.estado;}

	public int getEnEspera() {return this.listaEspera.size();}

	public int getInscriptos() {return this.listaInscriptos.size();}
